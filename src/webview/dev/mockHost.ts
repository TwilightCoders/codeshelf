...
function createMockShelves(): Shelf[] {
  return [
    ...
    },
    {
      ...
      items: [
        { kind: 'project', project: { name: 'glossary', path: '/mock/code/Gems/glossary', markers: ['.git', '*.gemspec'], primaryLanguage: 'ruby', gitBranch: 'main', lastModified: Date.now() - DAY * 2, starred: true } },
